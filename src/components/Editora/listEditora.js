                            ...
                            {editoras.map((editora) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/readEditora/${editora.id}`} className="btn btn-success mx2">Ler</Link>
                                            <Link to={`/updateEditora/${editora.id}`} className="btn btn-info mx2">Editar</Link>
                                            <button onClick={() => handleDelete(editora.id)} className="btn btn-danger">Deletar</button>
                                        </td>
                                    </tr>
                                )
                            })
